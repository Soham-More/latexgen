...
class LatexFile:
    ...
    def getLatexFileData(self):
        ...
        return (author, chapter, question_code, True)
    
    def __init__(self, file : str, style : Styles, config : Settings) -> None:
        self.filename = file
        self.config = config
        self.author, self.chapter, self.question_code, self.isMainFile = self.getLatexFileData()
